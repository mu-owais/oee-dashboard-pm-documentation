...
# Constantia Flexibles tracked production performance using manual Excel reports. Three
...
# \- Shift-level OEE comparison (donut chart)
...
# > The `.pbix` file is in `/dashboard`. It requires Power BI Desktop to open.

# > Panel screenshots are in `/dashboard` for direct viewing.
...
# | M1: Data \& Foundations | Oct 16–29 | Dataset import, Star Schema, DAX measures |

# | M2: Dashboard Design | Oct 30–Nov 12 | KPI panels, slicers, trend visualizations |

# | M3: Validation \& Testing | Nov 13–28 | OEE validation, UI refinement, slicer testing |

# | M4: Pitch Deck \& Report | Nov 29–Dec 4 | Final presentation, project documentation |
...
# balance of cost, usability, and scalability. Full analysis in

# `requirements/solution-scoring-matrix.md`.

# 

# \*\*Stakeholder Power/Interest mapping — adoption strategy\*\*  

# Four groups mapped. Production Manager (manage closely) drove the information hierarchy

# decision — supervisor summary view came first because supervisors are the decision-makers

# who act on OEE data in real time. Full analysis in `docs/stakeholder-analysis.md`.
...
# generation preceded live sensor connection. Full register in `docs/risk-matrix.md`.
...
# dashboard and a product. The OKRs above were defined for post-deployment. The build

# phase had no mechanism to measure whether supervisors used the dashboard differently

# than they had used Excel.

# 

# I am building a measurement framework to address this gap directly in my bachelor's

# thesis. The question — how to measure whether a digital tool created operational value,

# not just whether it was deployed — is the problem I have chosen to specialize in.
...
# | `dashboard/` | Power BI file + panel screenshots |
